<div class="row" style="text-align: center;">
	<div class="span6 offset3 alert alert-error" style="margin-top: 30px;">
...
<div class="row" style="text-align: center;">
	<div>
		<a href="javascript:alert('Nom nom nom!');"> <img style="width: 85%; cursor: url();" src="<?php bloginfo('stylesheet_directory');?>/img/shark.png" width="85%"
