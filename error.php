<div class="row" style="text-align: center;">
	<div class="span6 offset3 alert alert-error" style="margin-top: 30px; position: fixed; opacity: .9; z-index: 10;">
...
<div class="row" style="text-align: center;">
	<div>
		<a href="javascript:alert('Nom nom nom!');"> <img style="width: 85%; cursor: url(); position:relative; bottom: -60px;" src="<?php bloginfo('stylesheet_directory');?>/img/shark.png" width="85%"
