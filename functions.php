...
function amazon_func($atts) {
	...
	{
		$books_html .= "<iframe src='http://rcm-na.amazon-adsystem.com/e/cm?lt1=_blank&bc1=$bgcolor&IS2=1&npa=1&bg1=$bgcolor&fc1=000000&lc1=0000FF&t=$referrer&o=1&p=8&l=as4&m=amazon&f=ifr&ref=ss_til&asins=".$code."' style='width:120px;height:240px;' scrolling='no' marginwidth='0' marginheight='0' frameborder='0'></iframe>";
	}
	$books_html .= "</div>";
	return $books_html;
}
